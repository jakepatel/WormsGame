...
public class AdminLoginView extends JPanel{
	...
	// Private data fields for the important GUI components.
	  ...
	  public AdminLoginView(AdminLoginControl lc)
	  {
	    ...
	    JLabel instructionLabel = new JLabel("Enter your Administrator username and password to log in.", JLabel.CENTER);
	    labelPanel.add(errorLabel);
	    labelPanel.add(instructionLabel);

	    // Create a panel for the login information form.
	    JPanel loginPanel = new JPanel(new GridLayout(2, 2, 5, 5));
	    JLabel usernameLabel = new JLabel("Admin Username:", JLabel.RIGHT);
	    usernameField = new JTextField(10);
	    JLabel passwordLabel = new JLabel("Admin Password:", JLabel.RIGHT);
